...
- [x] RDDs created from list, with partitions, and from range
- [x] map() transformations produce correct output
- [x] filter() transformations produce correct output
- [x] flatMap() correctly splits sentences into words
- [x] Chained transformation pipeline works correctly
