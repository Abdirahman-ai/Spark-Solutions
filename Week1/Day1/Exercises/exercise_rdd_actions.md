...
- [x] All retrieval actions (collect, count, first, take, top, takeOrdered) work
- [x] Aggregation actions (reduce, fold) calculate correct values
- [x] countByValue correctly counts occurrences
