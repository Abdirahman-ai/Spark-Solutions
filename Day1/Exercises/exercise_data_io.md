...
- [x] Data loaded successfully from CSV
- [x] Header line filtered out
- [x] Records parsed into structured format
- [x] Revenue calculated and saved
- [x] Coalesce produces single output file
